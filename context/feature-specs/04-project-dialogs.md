...
Reuse the existing layout. Do not modify the navbar or sidebar behavior.
...
Keep the leyout minimal. Do not wrap this content in cards.
...
On mobile:
- tapping outside the sidebar will close it
...
Use mock project date only. Do not add API calls or persistence.
